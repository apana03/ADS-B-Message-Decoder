            ...
            while (true) {
                ...
                for (ObservableAircraftState state : manager.states()) {
                    ...
                    if(state.getData() != null ) {
                        if (state.getData().registration() != null)
                            System.out.printf("|%-10s|", state.getData().registration().string() + " ");
                        else System.out.print("|          |");
                        if (state.getData().model() != null)
                            System.out.printf("|%35s| ", state.getData().model());
                        else System.out.print("|                                  |");
                    }
                    else System.out.print("|          ||                                   |  ");
