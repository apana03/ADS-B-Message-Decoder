...
import ch.epfl.javions.GeoPos;import ch.epfl.javions.Units;
...
public class CprDecoderTest {
    ...
    void decodePositionWorks() {
        double x0 = scalb(111600, -17);
        double y0 = scalb(94445d, -17);
        double x1 = scalb(108865, -17);
        double y1 = scalb(77558d, -17);
    ...
    public void testDecodePosition() {
        double x0 = scalb(111600, -17);
        double x1 = scalb(108865, -17);
        double y0 = scalb(94445, -17);
        double y1 = scalb(77558, -17);
        int mostRecent = 0;
        GeoPos decodedPosition = CprDecoder.decodePosition(x0, y0, x1, y1, mostRecent);
    ...
    private final static double DIVIDER = scalb(1.0, 17);
