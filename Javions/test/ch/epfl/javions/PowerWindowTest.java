    ...
    void testCaLumea() throws IOException {
        ...
        while (powerWindow.isFull()) {
            ...
            for (int i = 0; i < powerWindow.size(); i++)
            {
                ...
                actualExpectedPowers[i] = powerWindow.get(i);

            }
            powerWindow.advance();
            System.out.println(powerWindow.position());
        }
        actualExpectedPowers[1200] = powerWindow.get(1199);
        System.out.println(powerWindow.get(1199));
        System.out.println(expectedPowers[1200]);
        assertArrayEquals(actualExpectedPowers, powers);
